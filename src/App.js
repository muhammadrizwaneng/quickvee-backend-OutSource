...
const ForgetPassword = lazy(
  () => import("./Components/Authenticate/forgetPassword/forgetPassword")
);
        ...
        <Routes>
          ...
          /> */}
            ...
            <Route
              ...
              element={<Main visible={"StoreSettingloyalty-program"} />}
            />
            ...
            <Route
              exact
              path="/store-reporting/drop-cash-report"
              element={<Main visible={"drop-cash-report"} />}
            />
            <Route
              exact
            ...
            <Route
              exact
              path="/store-reporting/gift-card-report"
              element={<Main visible={"gift-card-report"} />}
            />
            <Route
              exact
